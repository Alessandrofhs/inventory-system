<div class="left-side-bar">
    <div class="brand-logo">
        <a href="{{ route('admin.home') }}">
            ...
            <img src="{{ asset('/vendors/images/logointro.png') }}" alt="" class="light-logo" />
        </a>
            ...
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon bi bi-archive"></span><span class="mtext"> Goods Report </span>
                    </a>
                    <ul class="submenu">
                        <li><a href="ui-buttons.html">Use Report</a></li>
                        <li><a href="ui-cards.html">Return Report</a></li>
                    </ul>
                </li>
