                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="{{ route('admin.user.update', ['id' => $users->id]) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="phone" placeholder="Phone" value="{{ $users->phone }}">
                                @error('phone')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="address" placeholder="Address" value="{{ $users->address }}">
                                @error('address')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="photo" type="file" value="{{ $users->image }}">
                                @error('photo')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
